...
/**
 * The @SecurityRequirement annotation is used to define a security requirement for an operation. If
 * the whole API has the same security requirements, you can define them at the class level using
 * the @SecurityRequirement annotation.
 */
@RestController
