...
public class TransactionController {
  ...
  @PreAuthorize("hasRole('USER')")
  @ResponseStatus(HttpStatus.OK)
  public TransactionResponseDTO getTransactionByReference(@PathVariable String reference) {
  ...
  public Page<TransactionResponseDTO> searchTransactions(
      @Valid TransactionSearchCriteria criteria, Pageable pageable) {
  ...
  public TransactionResponseDTO approveTransaction(
      @PathVariable Long id, @Valid @RequestBody TransactionApprovalRequestDTO request) {
